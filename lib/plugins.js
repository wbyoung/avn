...
/**
 * Ensure that an object is an error. If not, create an error object.
 *
 * @private
 * @function plugins.~errorify
 * @param {?} error The object that could be an error or should be used to
 * create an error.
 * @param {Object} properties Properties to set on the error object.
 */
errorify = function(e, properties) {
